...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_archiveplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('tagged', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('optionalTemplate', self.gf('django.db.models.fields.URLField')(max_length=255, blank=True)),
        ))
        db.send_create_signal('cmsplugin_blog', ['ArchivePlugin'])


    def backwards(self, orm):
        # Deleting model 'ArchivePlugin'
        db.delete_table('cmsplugin_archiveplugin')
    ...
    models = {
        ...
        'cmsplugin_blog.archiveplugin': {
            'Meta': {'object_name': 'ArchivePlugin', 'db_table': "'cmsplugin_archiveplugin'", '_ormbases': ['cms.CMSPlugin']},
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'optionalTemplate': ('django.db.models.fields.URLField', [], {'max_length': '255', 'blank': 'True'}),
